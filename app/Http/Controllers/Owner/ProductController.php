...
class ProductController extends Controller
{
    ...
    {
        //ログインしているオーナーが作っているプロダクトが全て取得できる
        ...
        compact('ownerInfo')); //compact()の中の変数がviewに渡る
    }
    ...
    public function store(ProductRequest $request)
    {
        ...
        $request->validate([
            ...
            'price' => 'required|integer', //integer数字
            'sort_order' => 'nullable|integer', //nullでも可能
            'quantity' => 'required|integer',
            'shop_id' => 'required|exists:shops,id', //exists: 存在しているかどうか
